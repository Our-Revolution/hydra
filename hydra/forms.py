...
class GeoTargetForm(forms.Form):
    ...
    geojson = forms.CharField(max_length=10000000, widget=admin.widgets.AdminTextareaWidget, label="GeoJSON", help_text="You'll need to fetch this from Census.gov or Google or some such; ping Juliana or Jon. :D")
