...
class EventType(models.Model):
    ...
    rsvp_allow = models.IntegerField(blank=True, null=True, default=-1)
    rsvp_allow_reminder_email = models.IntegerField()
    rsvp_require_signup = models.IntegerField(blank=True, null=True, default=-1)
    rsvp_disallow_account = models.IntegerField(blank=True, null=True, default=-1)
...
class Event(BSDModel):
    ...
    def get_absolute_url(self):
        return "https://go.ourrevolution.com/page/event/detail/%s" % self.event_id_obfuscated
